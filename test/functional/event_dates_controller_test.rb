...
class EventDatesControllerTest < ActionController::TestCase
  ...
  test "should create event_date" do
    assert_difference('EventDate.count') do
      post :create, event_date: { description: @event_date.description, event_date: @event_date.event_date, event_dateable_id: @event_date.event_dateable_id, event_dateable_type: @event_date.event_dateable_type }
    end
  ...
  test "should update event_date" do
    put :update, id: @event_date, event_date: { description: @event_date.description, event_date: @event_date.event_date, event_dateable_id: @event_date.event_dateable_id, event_dateable_type: @event_date.event_dateable_type }
    assert_redirected_to event_date_path(assigns(:event_date))
  end
