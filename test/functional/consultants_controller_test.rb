...
class ConsultantsControllerTest < ActionController::TestCase
  ...
  test "should create consultant" do
    assert_difference('Consultant.count') do
      post :create, consultant: { charge: @consultant.charge, description: @consultant.description, image: @consultant.image, name: @consultant.name }
    end
  ...
  test "should update consultant" do
    put :update, id: @consultant, consultant: { charge: @consultant.charge, description: @consultant.description, image: @consultant.image, name: @consultant.name }
    assert_redirected_to consultant_path(assigns(:consultant))
  end
