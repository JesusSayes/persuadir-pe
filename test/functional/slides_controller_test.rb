...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { description: @slide.description, public: @slide.public, title: @slide.title }
    end
  ...
  test "should update slide" do
    put :update, id: @slide, slide: { description: @slide.description, public: @slide.public, title: @slide.title }
    assert_redirected_to slide_path(assigns(:slide))
  end
